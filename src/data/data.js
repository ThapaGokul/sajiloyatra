...
export const plannerNavData = [
  ...
  { id: 2, title: 'Bus Booking', href: '/bus', imageUrl: '/images/nav-bus.jpg' },
...
export const promoData = [
  { id: 1, title: 'YOUR NEPAL TRAVEL GUIDE', description: 'Everything you need to plan your adventure.', linkText: '→ Get the Guide', imageUrl: '/images/promo1.jpg', href: '/travel-guide' },
  { id: 2, title: 'CULTURAL EVENTS THIS WEEK', description: 'Live Music, Local Feasts, Art & More', linkText: '→ Check It Out', imageUrl: '/images/promo2.jpg', href: '/events' },
];